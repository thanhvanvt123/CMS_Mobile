                    ...
                    Container(
                     margin: const EdgeInsets.only(top: 10),
                      ...
                      child: Column(
                        children: [
                          Obx(() {
                            var listHisEvent = controller.history; 
                            if (listHisEvent.isEmpty) {
                              return Center(
                                child:
                            ...
                            return Container(
                              ...
                              child: ListView.builder(
                                ...
                                shrinkWrap: true,
                                scrollDirection: Axis.vertical,
                                itemCount: listHisEvent.length,
                                itemBuilder: (BuildContext ctx, index) {
                                  final event = listHisEvent[index];
                                  // if(event.status == 'Đang hoạt động') {}
