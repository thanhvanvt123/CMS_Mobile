              ...
              Obx(() {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      //title: Text(Formatter.shorten(event.description)),
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              //   ),
                              // ),
                              // Text(Formatter.shorten(event.location)),
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text('Mô tả: ' +
                                        Formatter.shorten(event.description)),
                                    Text('Ngày bắt đầu: ' +
                                        Formatter.date(event.startDate)),
                                    Text('Ngày kết thúc: ' +
                                        Formatter.date(event.endDate)),
                                    Text('Người tạo: ' +
                                        Formatter.shorten(event.email)),
                                    Text('Trạng thái: ' +
                                        Formatter.shorten(event.status)),
                                    //Text('Câu lạc bộ: ' +
                                       // Formatter.shorten(event.club)),
                                  ],
                                ),
                              ),
                            ],
                ...
                child: TabBar(
                  ...
                  tabs: [
                    Container(
                      width: 100,
                      child: Tab(
                        text: "Tài liệu và báo cáo",
                      ),
                    ),
                    Container(
                      width: 100,
                      child: Tab(
                        text: "Hình ảnh và video",
                      ),
                    ),
                    Container(
                      width: 100,
                      child: Tab(
                        text: "Chi phí và phần thưởng",
                      ),
                    ),
                  ],
